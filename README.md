...
![Демонстрация камеры с динамической перспективой](Demo/dynamic_perspective.gif)
...
![Демонстрация камеры с анизотропной перспективой](Demo/anisotropy_perspective.gif)
...
![Orthodox Camera Mini Guide](Demo/orthodox_camera.jpg)
